...
(function () {
  ...
  var COURSE = [
    ...
    { href: '3-backchannel-and-permissions.html', title: 'Backchannel & permissions', mins: 25, checks: 2 },
    { href: '4-see-what-changed.html', title: 'See what changed', mins: 10, checks: 2 },
    { href: '5-research-agent.html', title: 'The research agent', mins: 15, checks: 2 },
    { href: '6-personal-crm.html', title: 'The relationship agent', mins: 25, checks: 3 },
  ];
  ...
  if (file === 'index.html' || file === '') {
    ...
    if (next) {
      ...
      box.innerHTML =
        ...
        '<div class="sub">' + (p.done ? p.done + ' of ' + p.total + ' checkpoints done.' : 'Six modules, about 105 minutes end to end.') + '</div></div>' +
